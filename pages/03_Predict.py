...
def gradient_pipline():
    model = joblib.load("./modles/graidient_pipeline.joblib")
def naives_pipeline():
    pass
...
def create_form():
    ...
    with st.form('features'):
        ...
        with col4:
            ...
            monthlycharges = st.number_input('Enter Monthly Charges', min_value=20, max_value=120, step=50)
            totalcharges = st.number_input('Enter Total Charges', min_value=20, max_value=7000, step=50)
